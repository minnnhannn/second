<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="home.aspx.cs" Inherits="trading2018.home" %>
    ...
    <form id="form1" runat="server">
        <div class="page-wrap">
            ...
            <div class="md-content">
                ...
                <!-- hero -->
                <div class="hero" id="home" style="background-image: url('assets/img/bg/homebk.jpg');">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-8 ">
                                    ...
                                    <p class="hero__text">Ready to be a STOCK MONOPOLY !</p>
                                </div>
                            </div>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-0 col-lg-offset-1 ">
                                ...
                                <p class="fz-16"><asp:Label ID="lMessage" runat="server" Font-Names="Microsoft JhengHei"></asp:Label></p>
                            </div>
                        </div>

                        <!-- swiper__module swiper-container -->
                        <div class="swiper__module swiper-container mt-50" data-options='{"slidesPerView":3,"spaceBetween":30,"autoplay":3000,"breakpoints":{"640":{"slidesPerView":1},"991":{"slidesPerView":2}}}'>
                            <div class="swiper-wrapper">
                                ...
                                <div class="service mb-0">
                                    ...
                                    <h3 class="service__title">Money</h3>
                                    <p class="service__text" style="font-family:'Microsoft JhengHei'">每人統一先行發放一百萬元，</br>供進行股票交易!</p>
                                </div>
                                <!-- End / service -->
                                ...
                                <div class="service mb-0">
                                    ...
                                    <h3 class="service__title">Transaction</h3>
                                    <p class="service__text" style="font-family:'Microsoft JhengHei'">僅提供上市股交易</br>(上櫃股...等是沒有的)</p>
                                </div>
                                <!-- End / service -->

                                <!-- service -->
                                <div class="service mb-0">
                                    <div class="service__icon"><i class="pe-7s-search"></i></div>
                                    <h3 class="service__title">Search</h3>
                                    <p class="service__text" style="font-family:'Microsoft JhengHei'">僅提供上市股票查詢</br>(上櫃股...等是沒有的)</p>
                                </div>
                                <!-- End / service -->
                                ...
                                <!-- service -->
                                <div class="service mb-0">
                                    <div class="service__icon"><i class="pe-7s-note2"></i></div>
                                    <h3 class="service__title">Stock Data</h3>
                                    <p class="service__text" style="font-family:'Microsoft JhengHei'">股票資料的表格，標頭欄位可以點選，</br>以排序資料(交易紀錄、追蹤等)。</br>EX:預查詢今日最大or最小交易量，</br>可點選"成交量"排序。</p>
                                </div>
                                <!-- End / service -->
                                ...
                                <!-- service -->
                                <div class="service mb-0">
                                    <div class="service__icon"><i class="pe-7s-clock"></i></div>
                                    <h3 class="service__title">Historical Data</h3>
                                    <p class="service__text" style="font-family:'Microsoft JhengHei'">單一股票查詢，</br>可查詢各股歷史資訊。</p>
                                </div>
                                <!-- End / service -->
                                ...
                                <!-- service -->
                                <div class="service mb-0">
                                    <div class="service__icon"><i class="pe-7s-help1"></i></div>
                                    <h3 class="service__title">Q&A</h3>
                                    <p class="service__text" style="font-family:'Microsoft JhengHei'">任何系統問題，</br>都請直接聯繫助教!</p>
                                </div>
                                <!-- End / service -->
                                ...
                                <!-- service -->
                                <div class="service mb-0">
                                    <div class="service__icon"><i class="pe-7s-notebook"></i></div>
                                    <h3 class="service__title">Course Time</h3>
                                    <p class="service__text" style="font-family:'Microsoft JhengHei'">Monday PM 1:10 - 4:00</p>
                                </div>
                                <!-- End / service -->
                                        ...
                                        <div class="grid-item__content-wrapper" style="background: #e5e5e5">
                                            ...
                                            <div class="form-wrapper">
                                                ...
                                                <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                                                    ...
                                                    SelectCommand="SELECT [排名], SUBSTRING ( 姓名 ,1 , 1 )+'O'+SUBSTRING ( 姓名 ,3 , 1 )+' 同學' as '姓名', [帳戶總價值] FROM [Rank] ORDER BY [排名]"></asp:SqlDataSource>
